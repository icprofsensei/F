...
#3. Rank within lineage (whole integer number)
#4. Search taxa
result = PL('clean.csv', 'lineage', 2, ['Bacilli', 'Actinomycetes', 'Enterobacterales', 'Clostridia', 'Pseudomonadales', 'Burkholderiales', 'Bacteroidota', 'Hyphomicrobiales', 'Chromatiales', 'Rhodobacterales', 'Rhodospirillales', 'Methanomicrobia', 'Lysobacterales', 'Vibrionales', 'Thermoprotei', 'Sphingomonadales', 'Chlorobiota', 'Halobacteria','Alteromonadales'])
result.prep()
 ...
 # order = ['Bacilli', 'Actinomycetes', 'Enterobacterales', 'Clostridia', 'Pseudomonadales', 'Burkholderiales', 'Bacteroidota', 'Hyphomicrobiales', 'Chromatiales', 'Rhodobacterales', 'Rhodospirillales', 'Methanomicrobia', 'Lysobacterales', 'Vibrionales', 'Thermoprotei', 'Sphingomonadales', 'Chlorobiota', 'Halobacteria','Alteromonadales', 'Methanobacteria']