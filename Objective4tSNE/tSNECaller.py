...
from tSNESpecific import tSNElineage as PL
#1. File name
#2 Column title to be investigated. 'sci_name','cultures','lineage', '0', 'complex_medium', 'MediaID'
#3. Rank within lineage (whole integer number)
#4. Search taxa
result = PL('clean.csv', 'lineage', 0, ['Fusobacteria', 'Terrabacteria', 'Pseudomonadota', 'Euryarchaeota','FCB', 'Thermodesulfobacteriota'])
result.prep()
