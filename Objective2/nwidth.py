...
for index, row in check.iterrows():
    ...
    newrow = {'TaxID': row['TaxID'], 'Resources': row['Resources'], 'NicheWidth': row['Niche_Width'], 'GenomeSize': item['genome_size'], 'GeneCounts': item['gene_counts'], 'ProteinCodingGenes': item['protein_coding_genes']}
    data.append(newrow)
